    ...
    <div class="wrap-block">
        <div class="content-blok service-block">
            <div class="servie-block">
                ...
                <p class="service-info-subtitle">我们已定制多套解决方案，助您轻松跨入智能化生产时代</p>
...
const serviceIdeaInfo = ref<InfoData>({
  ...
  ideaDesc: '起世逸源专注互联网事业十余年，公司专注于软件开发、小程序开发、游戏开发以及生产系统开发等领域，致力于提供专业、高效的信息化解决方案。'
})
...
onBeforeMount(() => {
  serviceList.value = [
    ...
    {
      description: 'web服务',
      path: require('../assets/img/index/web服务.png')
    },
    {
      description: '小程序',
      path: require('../assets/img/index/小程序.png')
    }
  ]
  ...
  caseList.value = [
    ...
    {
      desc: '进销存管理系统',
      path: require('../assets/img/index/stock.jpg')
    },
    {
      desc: '公司业绩统计管理系统',
