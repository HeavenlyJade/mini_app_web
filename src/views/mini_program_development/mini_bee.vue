...
import {ref} from 'vue'
// 导入图片
import image1 from '@/assets/img/mini_pro/mini_bee/index.png'
import image2 from '@/assets/img/mini_pro/mini_bee/pag1.png'
import image3 from '@/assets/img/mini_pro/mini_bee/pag2.png'
import image4 from '@/assets/img/mini_pro/mini_bee/pag3.png'
import image7 from '@/assets/img/mini_pro/mini_bee/b1.png'
import image8 from '@/assets/img/mini_pro/mini_bee/b2.png'
import image9 from '@/assets/img/mini_pro/mini_bee/b3.png'
import image10 from '@/assets/img/mini_pro/mini_bee/b4.png'
...
const features = [
  ...
  },
  {
    id: 2,
    title: '会员营销',
    content: '积分商城、签到领积分、会员系统、优惠券版块、分享好友、满额立减、配送费满减、下单返红包、第二件打折、兑换码、酒水寄存、老带新、新客专享、积分商城、积分签到、集点返红包、商品活动、餐桌预定、排队取号'
  },
  {
    id: 3,
    title: '订单处理',
    content: '新订单、待配送、预订单提醒、催单、退单/售后）'
  },
  {
    id: 4,
    title: '订单查询',
    content: '订单状态：不限待接单待核销待配送配送中已完成已取消\n' +
      '订单类型：不限普通单自提订单\n' +
      '预订单\n' +
      '支付方式：不限微信支付余额支付\n' +
      '下单日期：近七日近两日具体日期'
  },
  {
    ...
    content: '模板消息：微信接单助手\n' +
      '短信消息：增加手机号\n' +
      '打印机管理：打印订单语音提醒：自动接单、预订单提醒、取消单、退单、催单、异常单',
