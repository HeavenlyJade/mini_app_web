<template>
  <div id="app" class="force-scroll">
    <FixedImageContainer :imageSrc="backgroundImage" overlayText="库存管理"/>
    ...
    <div class="main-content">
      <div class="content">
        ...
        <div
          ...
          @mouseup="endDrag"
          @touchend="endDrag"
          style="display: flex;justify-content: center;border: 2px solid #000">
          <el-carousel ref="carouselRef"  :interval="3000" class="render-swiper" height="500px" motion-blur>
        ...
        <div class="image-description">
          ...
          <div style="display: flex;justify-content: center;align-items: center;margin-top: 15px">
            <div class="websiteTest">
              <a :href="sampleWebsiteUrl" target="_blank" class="sample-link no-purple-link">样例网站</a>
            </div>
          </div>
...
const sampleWebsiteUrl = config.sampleWebsiteUrl

// Dashboard 图片数组
const dashboardImages = [image1, image2, image3, image4, image5]
